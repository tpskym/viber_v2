...
def proc1b68be2d5a9a4d06adb59b874e1673ea(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "63523113-c389-4e76-aabe-ad6e8fbd7bda", service_data_bot_need, data, carousel_id): #proc_function_expect_user1b68be2d5a9a4d06adb59b874e1673ea
...
def proc095761bb67d8455bbf094e32d0e8dc4f(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "a24d0179-542a-46e3-abf8-fd3e3cf767a6", service_data_bot_need, data, carousel_id): #proc095761bb67d8455bbf094e32d0e8dc4f
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    ...
    if not SaveState(sender_id, "c5650320-774e-4131-a68f-461c3ec0d1b6", service_data_bot_need, data, carousel_id): #proc_expect_user_button_click095761bb67d8455bbf094e32d0e8dc4f
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    return
...
def procf6829c8beb464c618ab63bd31f6bc879(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "fe116741-94cb-4536-9b88-808f518091f4", service_data_bot_need, data, carousel_id): #procf6829c8beb464c618ab63bd31f6bc879
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    ...
    if isinstance(result_list, list):
        ...
        if not SaveState(sender_id, "016d88d7-b6e2-47e4-b05f-3781880d3337", service_data_bot_need, data, carousel_id): #proc_expect_comand_userf6829c8beb464c618ab63bd31f6bc879
            viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
            GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
            return
    elif result_list == "1":
...
def proc17c11a9477c8493db93470bdbee77ffc(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "776c4dae-8ab9-4075-81a6-c1915322c83b", service_data_bot_need, data, carousel_id): #proc17c11a9477c8493db93470bdbee77ffc
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    buttons = []
    viber.send_messages(sender_id, KeyboardMessage(min_api_version=4, keyboard={"InputFieldState": "hidden", "Type": "keyboard", "Buttons":buttons}))
    if not SaveState(sender_id, "d4453b50-4042-4ed3-baff-5357afc5f214", service_data_bot_need, data, carousel_id): #proc_expect_user_button_click17c11a9477c8493db93470bdbee77ffc
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    return
...
def proc11fe0cd9823f4515909ff0df1baccf1a(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "5fbb5d30-ba99-48e9-bb14-1b1b6a82b1c3", service_data_bot_need, data, carousel_id): #proc11fe0cd9823f4515909ff0df1baccf1a
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    ...
    if isinstance(result_list, list):
        ...
        if not SaveState(sender_id, "a217b7ab-4c64-4e96-93da-383caa1cdcd6", service_data_bot_need, data, carousel_id): #proc_expect_comand_user11fe0cd9823f4515909ff0df1baccf1a
            viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
            GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
            return
    elif result_list == "1":
...
def procb591e68ff608423c982dd67e280ab1d4(sender_id, message, data, service_data_bot_need, carousel_id):
    #Команды карусели (команды элемента карусели)
    if not SaveState(sender_id, "0fb96014-34d8-45c8-8218-80939cc4d1fe", service_data_bot_need, data, carousel_id): #procb591e68ff608423c982dd67e280ab1d4
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    buttons = []
    viber.send_messages(sender_id, KeyboardMessage(min_api_version=4, keyboard={"InputFieldState": "hidden", "Type": "keyboard", "Buttons":buttons}))
    if not SaveState(sender_id, "6de6c94f-7d84-4fa0-a41f-3d645f0c97dd", service_data_bot_need, data, carousel_id): #proc_expect_user_button_clickb591e68ff608423c982dd67e280ab1d4
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    return
...
def proce73308888cc644eea230a5c12d47ffd3(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "ea6f0dad-7752-4fbc-a23f-752df621a501", service_data_bot_need, data, carousel_id): #proce73308888cc644eea230a5c12d47ffd3
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    ...
    if isinstance(result_list, list):
        ...
        if not SaveState(sender_id, "e8700927-6240-439b-9720-690ab1fe4bde", service_data_bot_need, data, carousel_id): #proc_expect_comand_usere73308888cc644eea230a5c12d47ffd3
            viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
            GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
            return
    elif result_list == "1":
...
def proc317d123326fa48198178c3fa479cd7cc(sender_id, message, data, service_data_bot_need, carousel_id):
    #Команды карусели (команды элемента карусели)
    if not SaveState(sender_id, "43d408c2-43d1-4ae6-890e-0d158c45b582", service_data_bot_need, data, carousel_id): #proc317d123326fa48198178c3fa479cd7cc
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    buttons = []
    viber.send_messages(sender_id, KeyboardMessage(min_api_version=4, keyboard={"InputFieldState": "hidden", "Type": "keyboard", "Buttons":buttons}))
    if not SaveState(sender_id, "1ac1dca2-7952-42fa-a1dd-826e5d6c6d2f", service_data_bot_need, data, carousel_id): #proc_expect_user_button_click317d123326fa48198178c3fa479cd7cc
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    return
...
def proc5160f46d71b8466a8b28db1bf17d5392(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "aeca74c2-52b1-4d30-a9ba-c8428b87e2e0", service_data_bot_need, data, carousel_id): #proc5160f46d71b8466a8b28db1bf17d5392
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    ...
    if isinstance(result_list, list):
        ...
        if not SaveState(sender_id, "6cb4e94b-83a2-428f-9307-ae99e184ec5c", service_data_bot_need, data, carousel_id): #proc_expect_comand_user5160f46d71b8466a8b28db1bf17d5392
            viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
            GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
            return
    elif result_list == "1":
...
def procdae1f3640d8a4eb0aed3fc1b63e187aa(sender_id, message, data, service_data_bot_need, carousel_id):
    #Команды карусели (команды элемента карусели)
    if not SaveState(sender_id, "691d8577-7532-40a1-bfd4-80722507a29d", service_data_bot_need, data, carousel_id): #procdae1f3640d8a4eb0aed3fc1b63e187aa
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    buttons = []
    ...
    buttons.append({
        ...
        "Text": "Назад" })
    viber.send_messages(sender_id, KeyboardMessage(min_api_version=4, keyboard={"InputFieldState": "hidden", "Type": "keyboard", "Buttons":buttons}))
    if not SaveState(sender_id, "b29d8525-70f8-451c-978f-f75e05307295", service_data_bot_need, data, carousel_id): #proc_expect_user_button_clickdae1f3640d8a4eb0aed3fc1b63e187aa
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    return
...
def proca22a380f1e104600808c465bd6ab3777(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "96267b25-a093-4f5c-b2a7-a57a86e98cbd", service_data_bot_need, data, carousel_id): #proca22a380f1e104600808c465bd6ab3777
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    ...
    buttons.append({
        ...
        "Text": "Отменить" })
    viber.send_messages(sender_id, KeyboardMessage(min_api_version=4, keyboard={"InputFieldState": "hidden", "Type": "keyboard", "Buttons": buttons}))
    if not SaveState(sender_id, "5f4dea6a-db08-4790-9581-c48f836c8063", service_data_bot_need, data, carousel_id): #proc_expect_user_button_clicka22a380f1e104600808c465bd6ab3777
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    return
...
def procd2aeca9275214a6caa98de3001dd081f(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "41c5ee35-451b-481b-9c55-f4866ae76b98", service_data_bot_need, data, carousel_id): #proc_function_expect_userd2aeca9275214a6caa98de3001dd081f
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    return
...
def procd454043806d1401f87b5ab49f4142f18(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "c65a7ad7-e739-4c5e-bb8c-edabe57c136c", service_data_bot_need, data, carousel_id): #procd454043806d1401f87b5ab49f4142f18
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    viber.send_messages(sender_id, TextMessage(text="Оцените выполнение обращения"))
    ...
    buttons.append({
        ...
        "Text": "Пропустить" })
    viber.send_messages(sender_id, KeyboardMessage(min_api_version=4, keyboard={"InputFieldState": "hidden", "Type": "keyboard", "Buttons": buttons}))
    if not SaveState(sender_id, "9f367ade-66ae-40ea-b730-7427166e1ca5", service_data_bot_need, data, carousel_id): #proc_expect_user_button_clickd454043806d1401f87b5ab49f4142f18
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    return
...
def proc3ec26f31a5dd4ff7a95fc7c612cf273a(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "66e57791-83db-4c30-988e-82517114088f", service_data_bot_need, data, carousel_id): #proc_function_expect_user3ec26f31a5dd4ff7a95fc7c612cf273a
        viber.send_messages(sender_id, TextMessage(text="ERROR SAVE STATE"))
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    return
...
list_procs = {}
list_procs.update( { '63523113-c389-4e76-aabe-ad6e8fbd7bda': proc_function_expect_user1b68be2d5a9a4d06adb59b874e1673ea} )
list_procs.update( { 'a24d0179-542a-46e3-abf8-fd3e3cf767a6': proc095761bb67d8455bbf094e32d0e8dc4f} )
list_procs.update( { 'c5650320-774e-4131-a68f-461c3ec0d1b6': proc_expect_user_button_click095761bb67d8455bbf094e32d0e8dc4f} )
list_procs.update( { 'fe116741-94cb-4536-9b88-808f518091f4': procf6829c8beb464c618ab63bd31f6bc879} )
list_procs.update( { '016d88d7-b6e2-47e4-b05f-3781880d3337': proc_expect_comand_userf6829c8beb464c618ab63bd31f6bc879} )
list_procs.update( { '776c4dae-8ab9-4075-81a6-c1915322c83b': proc17c11a9477c8493db93470bdbee77ffc} )
list_procs.update( { 'd4453b50-4042-4ed3-baff-5357afc5f214': proc_expect_user_button_click17c11a9477c8493db93470bdbee77ffc} )
list_procs.update( { '5fbb5d30-ba99-48e9-bb14-1b1b6a82b1c3': proc11fe0cd9823f4515909ff0df1baccf1a} )
list_procs.update( { 'a217b7ab-4c64-4e96-93da-383caa1cdcd6': proc_expect_comand_user11fe0cd9823f4515909ff0df1baccf1a} )
list_procs.update( { '0fb96014-34d8-45c8-8218-80939cc4d1fe': procb591e68ff608423c982dd67e280ab1d4} )
list_procs.update( { '6de6c94f-7d84-4fa0-a41f-3d645f0c97dd': proc_expect_user_button_clickb591e68ff608423c982dd67e280ab1d4} )
list_procs.update( { 'ea6f0dad-7752-4fbc-a23f-752df621a501': proce73308888cc644eea230a5c12d47ffd3} )
list_procs.update( { 'e8700927-6240-439b-9720-690ab1fe4bde': proc_expect_comand_usere73308888cc644eea230a5c12d47ffd3} )
list_procs.update( { '43d408c2-43d1-4ae6-890e-0d158c45b582': proc317d123326fa48198178c3fa479cd7cc} )
list_procs.update( { '1ac1dca2-7952-42fa-a1dd-826e5d6c6d2f': proc_expect_user_button_click317d123326fa48198178c3fa479cd7cc} )
list_procs.update( { 'aeca74c2-52b1-4d30-a9ba-c8428b87e2e0': proc5160f46d71b8466a8b28db1bf17d5392} )
list_procs.update( { '6cb4e94b-83a2-428f-9307-ae99e184ec5c': proc_expect_comand_user5160f46d71b8466a8b28db1bf17d5392} )
list_procs.update( { '691d8577-7532-40a1-bfd4-80722507a29d': procdae1f3640d8a4eb0aed3fc1b63e187aa} )
list_procs.update( { 'b29d8525-70f8-451c-978f-f75e05307295': proc_expect_user_button_clickdae1f3640d8a4eb0aed3fc1b63e187aa} )
list_procs.update( { '96267b25-a093-4f5c-b2a7-a57a86e98cbd': proca22a380f1e104600808c465bd6ab3777} )
list_procs.update( { '5f4dea6a-db08-4790-9581-c48f836c8063': proc_expect_user_button_clicka22a380f1e104600808c465bd6ab3777} )
list_procs.update( { '41c5ee35-451b-481b-9c55-f4866ae76b98': proc_function_expect_userd2aeca9275214a6caa98de3001dd081f} )
list_procs.update( { 'c65a7ad7-e739-4c5e-bb8c-edabe57c136c': procd454043806d1401f87b5ab49f4142f18} )
list_procs.update( { '9f367ade-66ae-40ea-b730-7427166e1ca5': proc_expect_user_button_clickd454043806d1401f87b5ab49f4142f18} )
list_procs.update( { '66e57791-83db-4c30-988e-82517114088f': proc_function_expect_user3ec26f31a5dd4ff7a95fc7c612cf273a} )

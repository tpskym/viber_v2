    ...
    if is_error:
        ...
        if state:
            if str(text) == "1":
                ...
                viber.send_messages(sender_id, TextMessage(text=str(text_error)))
                return "1"
        else:
            text_error = text
            viber.send_messages(sender_id, TextMessage(text="error with code:" + str(text_error)))
...
def proc_function76456fc5a5d34b5481dcb15c34787790(sender_id, text, data, carousel_id):
    ...
    if is_error:
        ...
        if state:
            viber.send_messages(sender_id, TextMessage(text=str("Зарегистрирован документ:" + str(text))))
...
def proc84c5c09c78824f2f819bd1eef1b3913e(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if GetIdStateForClearData() == "84c5c09c-7882-4f2f-819b-d1eef1b3913e":
        ...
        carousel_id = ''
        data = {}
    viber.send_messages(sender_id, TextMessage(text="Выбранное обращение"))
...
def proca0981bccc8ee486e943257b9de36f2d1(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if GetIdStateForClearData() == "a0981bcc-c8ee-486e-9432-57b9de36f2d1":
        ...
        carousel_id = ''
        data = {}
    viber.send_messages(sender_id, TextMessage(text="Уточнения не внесены"))
...
def proce022f99d4b914e8a8469546d143ff4e5(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if GetIdStateForClearData() == "e022f99d-4b91-4e8a-8469-546d143ff4e5":
        ...
        carousel_id = ''
        data = {}
    viber.send_messages(sender_id, TextMessage(text="Уточнения внесены"))
    proc095761bb67d8455bbf094e32d0e8dc4f(sender_id, message, data, service_data_bot_need, carousel_id) #Переход на Выбор действия
    return
...
def proc5160f46d71b8466a8b28db1bf17d5392(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if not SaveState(sender_id, "5160f46d-71b8-466a-8b28-db1bf17d5392", service_data_bot_need, data, carousel_id): #proc5160f46d71b8466a8b28db1bf17d5392
        ...
        GoToStateError(sender_id, message, GetIdErrorState(), {}, {}, "")
        return
    viber.send_messages(sender_id, TextMessage(text="Обращения для подтверждения"))
...
def proc3acf9e3b54a5487191e24a5de6948277(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if GetIdStateForClearData() == "3acf9e3b-54a5-4871-91e2-4a5de6948277":
        ...
        carousel_id = ''
        data = {}
    viber.send_messages(sender_id, TextMessage(text="Обращение оклонено"))
    proc095761bb67d8455bbf094e32d0e8dc4f(sender_id, message, data, service_data_bot_need, carousel_id) #Переход на Выбор действия
    return
...
def proc7e43a7686c964691abb16ccf4e47e119(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if GetIdStateForClearData() == "7e43a768-6c96-4691-abb1-6ccf4e47e119":
        ...
        carousel_id = ''
        data = {}
    viber.send_messages(sender_id, TextMessage(text="Обращение не подтверждено"))
...
def procffaaa8bf92394b6c9ff547b87743d7df(sender_id, message, data, service_data_bot_need, carousel_id):
    ...
    if GetIdStateForClearData() == "ffaaa8bf-9239-4b6c-9ff5-47b87743d7df":
        ...
        carousel_id = ''
        data = {}
    viber.send_messages(sender_id, TextMessage(text="Обращение отклонено"))
    proc5160f46d71b8466a8b28db1bf17d5392(sender_id, message, data, service_data_bot_need, carousel_id) #Переход на Обращения для подтверждения
    return
...
def proc_get_list_cortegescdab1713d317452bbbdb8a484d513051(sender_id, data, carousel_id):
    ...
    if is_error:
        ...
        if state:
            ...
            list_ret_full = []
            if len(list) == 0:
                viber.send_messages(sender_id, TextMessage(text="Нет сообщений за последние 5 дней"))
                return "OK"
            for incident in list:
                list_ret.append((incident.get('id'),incident.get('view')))
                list_ret_full.append((incident.get('id'),incident.get('detail_view')))
...
list_procs.update( { '6456fc5-a5d3-4b54-81dc-b15c347877907': proc_function_expect_user76456fc5a5d34b5481dcb15c34787790,'76456fc5-a5d3-4b54-81dc-b15c34787790without_registration': False} )
...
list_procs.update( { '2520952-7570-4b2a-907c-b2e089e0ed771': proc_expect_comand_user1252095275704b2a907cb2e089e0ed77,'12520952-7570-4b2a-907c-b2e089e0ed77without_registration': False} )
...
list_procs.update( { 'd689fd1-8d59-4246-8b18-92b7a2f97292e': proc_expect_user_button_clicked689fd18d5942468b1892b7a2f97292,'ed689fd1-8d59-4246-8b18-92b7a2f97292without_registration': False} )
...
list_procs.update( { 'b53668e-eb8e-4153-bdf7-a72781739830b': proc_function_expect_userbb53668eeb8e4153bdf7a72781739830,'bb53668e-eb8e-4153-bdf7-a72781739830without_registration': False} )
...
list_procs.update( { 'cca60de-6e56-43a0-a27b-251f132fafac4': proc_expect_user_button_click4cca60de6e5643a0a27b251f132fafac,'4cca60de-6e56-43a0-a27b-251f132fafacwithout_registration': False} )
...
list_procs.update( { 'f2c3d62-5e2f-4665-bf75-177d4363273c4': proc_function_expect_user4f2c3d625e2f4665bf75177d4363273c,'4f2c3d62-5e2f-4665-bf75-177d4363273cwithout_registration': False} )
...
list_procs.update( { 'dab1713-d317-452b-bbdb-8a484d513051c': proc_expect_comand_usercdab1713d317452bbbdb8a484d513051,'cdab1713-d317-452b-bbdb-8a484d513051without_registration': False} )
...
list_procs.update( { '263c108-cd64-43a2-b367-8ab97a445fc76': proc_expect_user_button_click6263c108cd6443a2b3678ab97a445fc7,'6263c108-cd64-43a2-b367-8ab97a445fc7without_registration': False} )
...
list_procs.update( { '7dc6d45-6b09-4b7c-8dff-0942edf2acb5f': proc_function_expect_userf7dc6d456b094b7c8dff0942edf2acb5,'f7dc6d45-6b09-4b7c-8dff-0942edf2acb5without_registration': False} )
